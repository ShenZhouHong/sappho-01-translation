...
% Document Metadata
\title{
  \textbf{\textsc{Ode to Aphrodite:} \\ A Translation of Sappho Fragment 1}
}
\author{
...
\clearpage
\input{sections/interlinear.tex}

\vfill
\begin{center}
This translation is typeset in \LaTeX, and is version-controlled via git. Historical revisions of this document, including full project repository, are available upon request.
\end{center}
